...
mgHubble[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:= \[Sqrt]((2 mg\[Rho]BE[T\[Gamma],0]+4mg\[Rho]FDM[T\[Gamma],0,mgme]+2mg\[Rho]FD[T\[Nu]e,0]+4mg\[Rho]FD[T\[Nu]\[Mu],\[Mu]\[Nu]]-mgPint[T\[Gamma]]+T\[Gamma] mgdPintdT[T\[Gamma]]) (8 \[Pi])/(3 (1.2209 10^19 10^3)^2));


mgdataX=Import["Thermo_Tables/rho_FD.cvs","Table",HeaderLines-> 0];
mg\[Rho]FDMX=Interpolation[mgdataX];

mgHubbleTaboft[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:= 1/T\[Gamma]^2 \[Sqrt]((2 mg\[Rho]BE[T\[Gamma],0]+4 T\[Gamma]^4 mg\[Rho]FDMX[T\[Gamma]/me]+2mg\[Rho]FD[T\[Nu]e,0]+4mg\[Rho]FD[T\[Nu]\[Mu],\[Mu]\[Nu]]-mgPint[T\[Gamma]]+T\[Gamma] mgdPintdT[T\[Gamma]]) (8 \[Pi])/3);

mgHubbleTabofa[z\[Gamma]_,z\[Nu]e_,z\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_,a_]:= 1/((z\[Gamma] mgm0)/a)^2 \[Sqrt]((2 mg\[Rho]BE[(z\[Gamma] mgm0)/a,0]+4 ((z\[Gamma] mgm0)/a)^4 mg\[Rho]FDMX[(z\[Gamma] mgm0)/a/mgme]+2mg\[Rho]FD[(z\[Nu]e mgm0)/a,0]+4mg\[Rho]FD[(z\[Nu]\[Mu] mgm0)/a,\[Mu]\[Nu]]-mgPint[(z\[Gamma] mgm0)/a]+((z\[Gamma] mgm0)/a) mgdPintdT[(z\[Gamma] mgm0)/a]) (8 \[Pi])/3);

mg\[Rho]tot[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:=(2 mg\[Rho]BE[T\[Gamma],0]+4mg\[Rho]FDM[T\[Gamma],0,mgme]+2mg\[Rho]FD[T\[Nu]e,0]+4mg\[Rho]FD[T\[Nu]\[Mu],\[Mu]\[Nu]]);

mgptot[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:=(1/3 2 mg\[Rho]BE[T\[Gamma],0]+4mgpFDM[T\[Gamma],0,mgme]+1/3 2mg\[Rho]FD[T\[Nu]e,0]+4 1/3 mg\[Rho]FD[T\[Nu]\[Mu],\[Mu]\[Nu]]);

mgRHSec[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:=-3 mgHubble[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],\[Mu]\[Nu],MZ](mg\[Rho]tot[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],\[Mu]\[Nu],MZ]+ mgptot[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],\[Mu]\[Nu],MZ]);


(* ::Input::Initialization:: *)
mgFAC=1/(6.58212 10^-16 10^-6); (* Converts MeV to s^-1 *)

mgdT\[Gamma]dt[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:=-(mgFAC/mgPartial\[Gamma]e[T\[Gamma]])(4 mgHubble[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],0,0] ( 2 mg\[Rho]BE[T\[Gamma],0]) +3 mgHubble[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],0,0]*4*(mg\[Rho]FDM[T\[Gamma],0,mgme]+mgpFDM[T\[Gamma],0,mgme])+ mg\[CapitalDelta]\[Rho]SM\[Nu]e[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu]]+2 mg\[CapitalDelta]\[Rho]SM\[Nu]\[Mu][T\[Gamma],T\[Nu]e,T\[Nu]\[Mu]]+ 3 mgHubble[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],0,0] T\[Gamma] mgdPintdT[T\[Gamma]]);


mgdT\[Nu]dt[T\[Gamma]_,T\[Nu]e_,T\[Nu]\[Mu]_,\[Mu]\[Nu]_,MZ_]:=(-mgHubble[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu],0,0] T\[Nu]e + T\[Nu]e/(3 4 2 mg\[Rho]FD[T\[Nu]e,0] ) (mg\[CapitalDelta]\[Rho]SM\[Nu]e[T\[Gamma],T\[Nu]e,T\[Nu]\[Mu]]+2mg\[CapitalDelta]\[Rho]SM\[Nu]\[Mu][T\[Gamma],T\[Nu]e,T\[Nu]\[Mu]]))mgFAC;


(* ::Input::Initialization:: *)
mgm0=mgme;
mgdz\[Gamma]da[z\[Gamma]_,z\[Nu]e_,z\[Nu]\[Mu]_,\[Mu]\[Nu]_,g_,MZ_,a_]:=z\[Gamma]/a (1/(z\[Gamma] mgm0/a *mgPartial\[Gamma]e[z\[Gamma] mgm0/a]) (z\[Gamma] mgm0/a *mgPartial\[Gamma]e[z\[Gamma] mgm0/a]-4*2*mg\[Rho]BE[z\[Gamma] mgm0/a,0]-3*4(mg\[Rho]FDM[z\[Gamma] mgm0/a,0,mgme]+mgpFDM[z\[Gamma] mgm0/a,0,mgme])-3*z\[Gamma] mgm0/a mgdPintdT[z\[Gamma] mgm0/a]-( mg\[CapitalDelta]\[Rho]SM\[Nu]e[z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a]+2 mg\[CapitalDelta]\[Rho]SM\[Nu]\[Mu][z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a])/mgHubble[z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a,0,0]));

mgdz\[Nu]eda[z\[Gamma]_,z\[Nu]e_,z\[Nu]\[Mu]_,\[Mu]\[Nu]_,g_,MZ_,a_]:=z\[Nu]e/a (mg\[CapitalDelta]\[Rho]SM\[Nu]e[z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a]/(4 mgHubble[z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a,0,0]*2*mg\[Rho]FDM[z\[Nu]e mgm0/a,0,0]));

mgdz\[Nu]\[Mu]da[z\[Gamma]_,z\[Nu]e_,z\[Nu]\[Mu]_,\[Mu]\[Nu]_,g_,MZ_,a_]:= z\[Nu]\[Mu]/a (mg\[CapitalDelta]\[Rho]SM\[Nu]\[Mu][z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a]/(4 mgHubble[z\[Gamma] mgm0/a,z\[Nu]e mgm0/a,z\[Nu]\[Mu] mgm0/a,0,0]*2*mg\[Rho]FDM[z\[Nu]\[Mu] mgm0/a,0,0]));
...
z\[Gamma]'[a]==mgdz\[Gamma]da[z\[Gamma][a],z\[Nu][a],z\[Nu][a],0,0,0,a],z\[Nu]'[a]==1/3 (mgdz\[Nu]eda[z\[Gamma][a],z\[Nu][a],z\[Nu][a],0,0,0,a]+2mgdz\[Nu]\[Mu]da[z\[Gamma][a],z\[Nu][a],z\[Nu][a],0,0,0,a]),
...
T\[Gamma]'[t]==mgdT\[Gamma]dt[T\[Gamma][t],T\[Nu][t],T\[Nu][t],0,0],T\[Nu]'[t]==mgdT\[Nu]dt[T\[Gamma][t],T\[Nu][t],T\[Nu][t],0,0],
T\[Gamma][mgt0]==T\[Nu]0,T\[Nu][mgt0]==T\[Nu]0},{T\[Gamma],T\[Nu]},{t,mgt0,mgtmax},PrecisionGoal->8,AccuracyGoal->8];
...
(* ::Input::Initialization:: *)
resultvec=Quiet[mgNeutrinoDecoupling[TnuStart]];
